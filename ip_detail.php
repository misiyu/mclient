...
<div id="head">
	...
	<div id="ndn-switch" class="ndn_switch" >
		<label class="switch" >
			<input type="checkbox" value="" title="" onClick="ndn_switch(this)" id="ip-ndn-checkbox" />
...
<div id="main">
	<div id="content">
        ...
        <div class="con">
            ...
            <div>
                <a href="./ip_detail.php" title="/misiyu/aaa/testApp/zgdx-1080.mp4" target="_blank"  onClick="play(this) ; return false ;" >北大</a>
                <br/>
                <span>主权网内部数据</span>
            </div>
        </div>
        <div class="con">
            ...
            <div>
                <a href="./ip_detail.php" title="/-DX/ndn/edu/dx/node6/video/dagada-720-01.mp4" target="_blank"  onClick="play(this) ; return false ;" >日剧</a>
                <br/>
                <span>电信主权网数据</span>
            </div>
        </div>
        <div class="con">
            ...
            <div>
                <a href="ip_detail.php" title="59.42.210.189/test4.txt" target="_blank"  onClick="play(this) ; return false ;" >小说.txt</a>
                <br/>
                <span>IP网数据</span>
            </div>
        </div>
