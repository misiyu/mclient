...
(function(pop){
	...
	pop.alert1 = function(title ,content, cb, opts){
	...
	//确认框
	pop.confirm1 = function(title , btn1 , btn2 , content, cb, opts){
	...
	pop.prompt1 = function(title , btn1 , btn2 , content, value, cb, opts){
		
		let $content = $(`
			<div>
				<p>${content}</p>
				<input type="text" id="prompt-input" class="form-control" value="${value}"/>
			</div>
		`);
