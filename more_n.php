...
<div id="main">
    <div id="content">
        ...
        <div class="con">
            ...
            <div>
                <a href="./ip_detail.php" title="127.0.0.1" target="_blank"  >IP网数据</a>
                <br/>
                <span>IP互联网</span>
            </div>
        </div>
        <div class="con">
            ...
            <div>
                <a href="./isn_detail.php" title="127.0.0.1" target="_blank"  >pkusz-js主权网资源</a>
                <br/>
                <span>主权网内部数据</span>
            </div>
        </div>
        <div class="con">
            ...
            <div>
                <a href="./osn_detail.php" title="127.0.0.1" target="_blank"  >dx主权网资源</a>
                <br/>
                <span>电信主权网数据</span>
            </div>
        </div>
		...
		if( $msg == ""){
			...
			echo '
  			<div class="con">
        		    	...
        		    	<div>
        		        		<a href="'.$link.'" target="_blank">'.$first_name.'</a>
       		         	<br/>
       		         		<span>'.$remark.'</span>
       		     	</div>
        			</div>
...
<script src="./js/bdsug.js?v=1.0.3.0" ></script>
<div class="footer3" >
